...
function Sidebar() {
  const [selection, setSelection] = useState([true, false, false, false, false]);
  ...
  return (
    <div className="sidebar">
      ...
      <div className="sidebar__list">
        ...
        <div onClick={() => {setSelection([false, false, true, false, false])}}>
          <SidebarOption
            name="Recent"
        ...
        <div onClick={() => {setSelection([false, false, false, true, false])}}>
          <SidebarOption
            name="Starred"
            selected={selection[3]}
            icon={<svg width="24px" height="24px" viewBox="0 0 24 24" focusable="false" fill="#000000"><path d="M22 9.24l-7.19-.62L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21 12 17.27 18.18 21l-1.63-7.03L22 9.24zM12 15.4l-3.76 2.27 1-4.28-3.32-2.88 4.38-.38L12 6.1l1.71 4.04 4.38.38-3.32 2.88 1 4.28L12 15.4z"></path></svg>}
          />
        </div>
        <div onClick={() => {setSelection([false, false, false, false, true])}}>
          <SidebarOption
            name="Trash" 
            selected={selection[4]}
            icon={<svg width="24px" height="24px" viewBox="0 0 24 24" fill="#000000" focusable="false"><path d="M0 0h24v24H0z" fill="none"></path><path d="M15 4V3H9v1H4v2h1v13c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V6h1V4h-5zm2 15H7V6h10v13z"></path><path d="M9 8h2v9H9zm4 0h2v9h-2z"></path></svg>}
          />
        </div>
      </div>
    </div>
